...
#SBATCH --job-name=DDM ## job name
#SBATCH --output=DDM_RUN.txt ## job output location, default is in this_file.sh folder
...
conda activate ddm_project ## activate environment
​python3 main.py